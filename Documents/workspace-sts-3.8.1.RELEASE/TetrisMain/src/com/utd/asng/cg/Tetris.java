 ...
 * This is main class for the Tetris game. 
 *
 */
public class Tetris extends JFrame implements MouseMotionListener {
...
//		
		...
		add(side, BorderLayout.EAST);//This could even be placed on the west
			...
			public void keyPressed(KeyEvent e) {
				...
				case KeyEvent.VK_DOWN:
					if(!isPaused && dropCooldown == 0) {
						logicTimer.setCyclesPerSecond(speed);
					}
					break;

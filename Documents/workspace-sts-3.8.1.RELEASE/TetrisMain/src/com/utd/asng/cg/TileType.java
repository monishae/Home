...
public enum TileType {
	 ...
	 * Piece TypeO.
	 */
	TypeOne(new Color(BoardPanel.COLOR_MAX, BoardPanel.COLOR_MAX, BoardPanel.COLOR_MIN), 2, 2, 2, new boolean[][] {
		{
			false,	false,
			true,	false,
		},
	 ...
	 * Piece TypeTwo
	 */
	TypeTwo(new Color(BoardPanel.COLOR_MAX, BoardPanel.COLOR_MAX, BoardPanel.COLOR_MIN), 2, 2, 2, new boolean[][] {
		{
			true,	false,
			true,	false,
		},
	 ...
	 * Piece Type-_.
	 */
	Type2Box(new Color(BoardPanel.COLOR_MAX, 127, BoardPanel.COLOR_MIN), 2, 2, 2, new boolean[][] {
		{
			true,	false,
			false,	true,
		},
	 ...
	 * Piece TypeMountain.
	 */
	Typemountain(new Color(BoardPanel.COLOR_MAX, BoardPanel.COLOR_MAX, BoardPanel.COLOR_MIN), 3, 3, 2, new boolean[][] {
		{
			false,	true,	false,
			true,	false,	true,
			false,	false,	false,
	 ...
	 * Piece TypeSlantLine.
	 */
	TypeSlantLine(new Color(BoardPanel.COLOR_MAX, BoardPanel.COLOR_MIN, BoardPanel.COLOR_MAX), 3, 3, 2, new boolean[][] {
		{
			true,	false,	false,
			false,	true,	false,
			false,	false,	true,
	...
	/**
	 * Piece TypeFirstShape.
	 */
	TypeFirstShape(new Color(BoardPanel.COLOR_MIN, BoardPanel.COLOR_MAX, BoardPanel.COLOR_MIN), 3, 3, 2, new boolean[][] {
		{
			true,	false,	false,
			false,	true,	true,
			false,	false,	false,
	...
	/**
	 * Piece TypeThreeBoxes.
	 */
	TypeThreeBoxes(new Color(BoardPanel.COLOR_MIN, BoardPanel.COLOR_MAX, BoardPanel.COLOR_MIN), 3, 3, 2, new boolean[][] {
		{
			false,	false,	false,
			true,	true,	true,
			false,	false,	false,
	...
	/**
	 * Piece TypeRightAngle
	 */
	TypeRightAngle(new Color(BoardPanel.COLOR_MAX, BoardPanel.COLOR_MAX, BoardPanel.COLOR_MIN), 2, 2, 1, new boolean[][] {
		{
			false,	true,
			true,	true,
		},

...
public class SidePanel extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		g.drawString("Up Arrow- Rotate Anticlockwise", LARGE_INSET, offset += TEXT_STRIDE);
		//g.drawString("E - Rotate Clockwise", LARGE_INSET, offset += TEXT_STRIDE);
		g.drawString("Down - Drop", LARGE_INSET, offset += TEXT_STRIDE);
		g.drawString("Spacebar - Pause Game", LARGE_INSET, offset += TEXT_STRIDE);
...
//	/ Adding these lines of code makes the textbox be redrawn over and over
		
//		scoreText.setLayout(null);
//		scoreText.setBounds(SMALL_INSET, offset += TEXT_STRIDE, 100, 40);
//		
//		
//		speedText.setLayout(null);
//		speedText.setBounds(SMALL_INSET, offset += TEXT_STRIDE+10, 100, 40);
//		
//		
//		rowText.setLayout(null);
//		rowText.setBounds(SMALL_INSET, offset += TEXT_STRIDE+10, 100, 40);
//		
//		//JTextField row
//		
//		this.add(scoreText);
...
//		this.add(rowText);
	    ...
	    btnQuit.setBounds(LARGE_INSET, offset += TEXT_STRIDE, 70, 40);
		...
		/*
		 * Draw preview of the next piece that will come up.
		 */

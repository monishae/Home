...
//			Dimension size = (new BoardPanel()).getSize();
//
...
//    int h = size.height / rows;;
		...
		this.addMouseMotionListener(new MouseMotionAdapter()
			{
					...
					public void mouseMoved(final MouseEvent e)
					{
						...
						if(x>0 && x<PANEL_WIDTH && y>0 && y< PANEL_HEIGHT ){
							...
							tetris.setIsPaused(true);
						}
						else
							tetris.setIsPaused(false);
					}
			});
	...
	public void paintComponent(Graphics g) {
		...
		JTextField t1 = new JTextField("Clock Speed");
		t1.setLayout(null);
		t1.setBounds(CENTER_X,350,10,30);
		//tetris.ad
...
//	public void addMouseMotionListener(MouseMotionAdapter l) {
//		
//		if (l == null) {
//            return;
//        }
